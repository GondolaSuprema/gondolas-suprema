...
function Login({ onLogin, setPage }) {
  ...
  return (
    <div style={{ display: "flex", alignItems: "center", justifyContent: "center", minHeight: "calc(100vh - 60px)", padding: 20 }}>
      <div style={{ background: COLORS.surface, border: "1px solid rgba(245,166,35,0.55)", borderRadius: 14, padding: 36, width: 380, maxWidth: "100%", boxShadow: "0 0 18px rgba(245,166,35,0.45), 0 0 44px rgba(245,166,35,0.22)" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          ...
          <button onClick={go} disabled={loading} style={{ background: loading ? COLORS.border : COLORS.orange, color: "#000", border: "none", padding: "12px", borderRadius: 9, fontWeight: 700, fontSize: 14, cursor: loading ? "not-allowed" : "pointer", fontFamily: "'DM Sans', sans-serif", marginTop: 2, boxShadow: loading ? "none" : "0 0 18px rgba(245,166,35,0.55)" }}>{loading ? "Entrando..." : "Entrar"}</button>
        </div>
      </div>
    </div>
  );
