...
export default function App() {
  ...
  return (
    <div style={{ background: "transparent", minHeight: "100vh", fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <div aria-hidden="true" style={{ position: "fixed", top: 0, left: 0, right: 0, bottom: 0, zIndex: -1, pointerEvents: "none", backgroundImage: "url(/watermark2.png)", backgroundRepeat: "no-repeat", backgroundPosition: "center", backgroundSize: "min(760px, 84vw)", opacity: 0.16 }} />
